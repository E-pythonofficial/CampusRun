        ...
        <div className="card-campus p-8">
          <form onSubmit={handleRegister} className="space-y-4">
            <div className="space-y-2">
              ...
              <Input placeholder="Adebayo Oluwaseun" className="bg-secondary/50 border-border" />
            </div>

            <div className="space-y-2">
              <Label className="text-card-foreground">Phone Number</Label>
              <Input placeholder="08012345678" className="bg-secondary/50 border-border" />
            </div>
            ...
            <div className="space-y-2">
              ...
              <Input placeholder="Computer Science" className="bg-secondary/50 border-border" />
            </div>
            ...
            {/* Role selector */}
            <div className="space-y-2">
              <Label className="text-card-foreground text-xs">Register as</Label>
